...
```
    ...
    n=  4: no-cache    5.2 ms,  cached    5.6 ms,  speedup 0.92x
    n=  8: no-cache   11.1 ms,  cached   10.1 ms,  speedup 1.10x
    n= 16: no-cache   23.6 ms,  cached   19.2 ms,  speedup 1.23x


    n= 32: no-cache   52.9 ms,  cached   37.5 ms,  speedup 1.41x


    n= 48: no-cache   84.4 ms,  cached   56.0 ms,  speedup 1.51x


    n= 60: no-cache  110.3 ms,  cached   70.4 ms,  speedup 1.57x
...
```
    ...
    Decode (one new token, with cache):                       1.51 ms
